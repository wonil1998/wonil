	    ...
	    <div class="container-fluid px-4">
               ...
               <div class="card mb-4">
                  <div class="card-header">
                     <i class="fas fa-table me-1"></i> 회원님이 자유게시판, Q&A에 작성한 댓글목록입니다.
                  </div>
                  <div class="card-body">
                     <table id="example" class="display" style="width: 100%">
                        ...
                        <tbody>
                           <c:forEach var="r" items="${rplist }" varStatus="status">
                              <tr>
                              <td>${r.con}</td>
                              <td>${r.indate}</td>
                              <td><a href="board_detail?b_num=${r.b_num}">${r.title }</a></td>
                              <td><a href="reply_del?num=${r.num}">삭제 </a></td>          
                              </tr>
                           </c:forEach>
                        </tbody>
                     </table>
