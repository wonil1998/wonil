...
<html lang="ko">
    ...
    <!-- top -->
        ...
        <!-- main -->
        <main>
        <form action="camp_mod_save" method="post" id="camp_save" encType="multipart/form-data">
			  ...
			  <div class="carousel-inner text-center mt-3">
	    		...
	    		<c:if test="${cflist0==null}">
				    <div id="tagArea" class="d-grid align-items-center justify-content-center " style="height:400px;">
					    ...
					    <img src="download?filename=${cflist0.filename}" class="mx-auto d-none" height="400">
						<input type="file" name="file1" id="newFile" hidden="true" value="${cflist0.filename}">
                		<input type="button" value="사진 선택" onclick="filedata_mod(this.id)" id="campFile1" class="form-control btn btn-danger"> 
	                 </div>
                 </c:if>
	    		<c:if test="${cflist0!=null}">
				    <div id="tagArea" class="d-grid align-items-center justify-content-center " style="height:400px;">
				    	<button type="button" class="btn btn-danger" onclick="fileRemove(this.id)" id="fileRemove1">제거</button>
					    <img src="download?filename=${cflist0.filename}" class="mx-auto" height="400">
						<input type="file" name="file1" id="newFile" hidden="true" value="${cflist0.filename}">
                		<input type="button" value="사진 선택" onclick="filedata_mod(this.id)" id="campFile1" class="form-control btn btn-danger  d-none"> 
	                 </div>
                 </c:if>
                 </div>
		    	<div class="carousel-item">
	    		<c:if test="${cflist1==null}">
				    <div id="tagArea" class="d-grid align-items-center justify-content-center " style="height:400px;">
				    	<button type="button" class="btn btn-danger d-none" onclick="fileRemove(this.id)" id="fileRemove2">제거</button>
					    <img src="download?filename=${cflist1.filename}" class="mx-auto d-none" height="400">
						<input type="file" name="file1" id="newFile" hidden="true" value="${cflist1.filename}">
                		<input type="button" value="사진 선택" onclick="filedata_mod(this.id)" id="campFile2" class="form-control btn btn-danger"> 
	                 </div>
                 </c:if>
	    		<c:if test="${cflist1!=null}">
				    <div id="tagArea" class="d-grid align-items-center justify-content-center " style="height:400px;">
				    	<button type="button" class="btn btn-danger" onclick="fileRemove(this.id)" id="fileRemove2">제거</button>
					    <img src="download?filename=${cflist1.filename}" class="mx-auto" height="400">
						<input type="file" name="file1" id="newFile" hidden="true" value="${cflist1.filename}">
                		<input type="button" value="사진 선택" onclick="filedata_mod(this.id)" id="campFile2" class="form-control btn btn-danger  d-none"> 
	                 </div>
                 </c:if>
                 </div>
		    	<div class="carousel-item">
	    		<c:if test="${cflist2==null}">
				    <div id="tagArea" class="d-grid align-items-center justify-content-center " style="height:400px;">
				    	<button type="button" class="btn btn-danger d-none" onclick="fileRemove(this.id)" id="fileRemove3">제거</button>
					    <img src="download?filename=${cflist2.filename}" class="mx-auto d-none" height="400">
						<input type="file" name="file1" id="newFile" hidden="true" value="${cflist2.filename}">
                		<input type="button" value="사진 선택" onclick="filedata_mod(this.id)" id="campFile3" class="form-control btn btn-danger"> 
	                 </div>
                 </c:if>
	    		<c:if test="${cflist2!=null}">
				    <div id="tagArea" class="d-grid align-items-center justify-content-center " style="height:400px;">
				    	<button type="button" class="btn btn-danger" onclick="fileRemove(this.id)" id="fileRemove3">제거</button>
					    <img src="download?filename=${cflist2.filename}" class="mx-auto" height="400">
						<input type="file" name="file1" id="newFile" hidden="true" value="${cflist2.filename}">
                		<input type="button" value="사진 선택" onclick="filedata_mod(this.id)" id="campFile3" class="form-control btn btn-danger  d-none"> 
	                 </div>
                 </c:if>
                 </div>
		    	<div class="carousel-item">
	    		<c:if test="${cflist3==null}">
				    <div id="tagArea" class="d-grid align-items-center justify-content-center " style="height:400px;">
				    	<button type="button" class="btn btn-danger d-none" onclick="fileRemove(this.id)" id="fileRemove4">제거</button>
					    <img src="download?filename=${cflist3.filename}" class="mx-auto d-none" height="400">
						<input type="file" name="file1" id="newFile" hidden="true" value="${cflist3.filename}">
                		<input type="button" value="사진 선택" onclick="filedata_mod(this.id)" id="campFile4" class="form-control btn btn-danger"> 
	                 </div>
                 </c:if>
	    		<c:if test="${cflist3!=null}">
				    <div id="tagArea" class="d-grid align-items-center justify-content-center " style="height:400px;">
				    	<button type="button" class="btn btn-danger" onclick="fileRemove(this.id)" id="fileRemove4">제거</button>
					    <img src="download?filename=${cflist3.filename}" class="mx-auto" height="400">
						<input type="file" name="file1" id="newFile" hidden="true" value="${cflist3.filename}">
                		<input type="button" value="사진 선택" onclick="filedata_mod(this.id)" id="campFile4" class="form-control btn btn-danger  d-none"> 
	                 </div>
                 </c:if>
                 </div>
		    	<div class="carousel-item">
	    		<c:if test="${cflist4==null}">
				    <div id="tagArea" class="d-grid align-items-center justify-content-center " style="height:400px;">
				    	<button type="button" class="btn btn-danger d-none" onclick="fileRemove(this.id)" id="fileRemove5">제거</button>
					    <img src="download?filename=${cflist4.filename}" class="mx-auto d-none" height="400">
						<input type="file" name="file1" id="newFile" hidden="true" value="${cflist4.filename}">
                		<input type="button" value="사진 선택" onclick="filedata_mod(this.id)" id="campFile5" class="form-control btn btn-danger"> 
	                 </div>
                 </c:if>
	    		<c:if test="${cflist4!=null}">
				    <div id="tagArea" class="d-grid align-items-center justify-content-center " style="height:400px;">
				    	<button type="button" class="btn btn-danger" onclick="fileRemove(this.id)" id="fileRemove5">제거</button>
					    <img src="download?filename=${cflist4.filename}" class="mx-auto" height="400">
						<input type="file" name="file1" id="newFile" hidden="true" value="${cflist4.filename}">
                		<input type="button" value="사진 선택" onclick="filedata_mod(this.id)" id="campFile5" class="form-control btn btn-danger  d-none"> 
	                 </div>
                 </c:if>
                 </div>
			  </div>
		...
		<div class="row ms-4">
		    <div class="col-md-5">
		        <div class="form-floating mb-3">
		            <input type="text" class="form-control" name="c_name" id="campName" placeholder="campName" value="${cvo.c_name}">
		            <label for="campName">캠핑장 이름</label>
		        </div>
		    </div>
		    <div class="col-md-5">
		        <div class="form-floating mb-3">
		            <input type="number" class="form-control" name="phone" id="campPhone" placeholder="campPhone" value="${cvo.phone}">
		    ...
		    <div class="col-md-5">
		        <div class="form-floating mb-3">
		            <input type="text" class="form-control" name="addr_detail" id="campAddr_detail" placeholder="campAddr_detail" value="${cvo.addr_detail}">
		            <label for="campAddr_detail">주소(상세)</label>
		        </div>
		    </div>
		    <div class="col-md-5">
		        <div class="form-floating mb-3">
		            <input type="number" class="form-control" name="c_price" id="campPrice" placeholder="campPrice" value="${cvo.c_price}">
		 ...
		 <div class="row mb-0">
		   <div class="col-md-0">
		      <div class="form-floating mb-3 mb-md-3">
		         ...
		         <textarea id="inputCon" name="n_con" placeholder="내용">${notice.n_con}</textarea><!-- noticeVO -->
		      </div>
		   </div>
		</div>
      </div>
  ...
  <div class="col-md-6">
	      <div class="card mb-3" style="max-width: 540px;">
	        <div class="row g-0">
	          <div class="col-md-5 d-grid align-items-center justify-content-center">
			    	<img src="download?filename=${room.filename}" class="mx-auto" height="140">
	                <input type="file" name="file2" hidden="true" value="${room.filename}">
	                <input type="button" value="사진 선택" onclick="filedata_mod(this.id)" id="roomFile${status.count}" class="btn btn-danger d-none" name="room_filename">
					<input type="button" value="제거" onclick="cardRemove(this.id)" class="btn btn-danger" id="roomCard${status.count}">
	          </div>
	          <div class="col-md-7">
	            <div class="card-body">
	              <div class="row">
				    <div class="col-md-12">
				        <div class="form-floating mb-1">
				            <input type="text" class="form-control room_name" id="r_name" placeholder="방 이름" name="r_name" value="${room.r_name}">
				            <label for="campName">방 이름</label>
				        </div>
				    </div>
				    <div class="col-md-12">
				        <div class="form-floating mb-1">
				            <input type="number" class="form-control room_max_cnt" id="max_cnt" placeholder="최대 인원" name="max_cnt" value="${room.max_cnt}">
				            <label for="campPhone">최대 인원</label>
				        </div>
				    </div>
				    <div class="col-md-12">
				        <div class="form-floating mb-1">
				            <input type="number" class="form-control room_basic_cnt" id="basic_cnt" placeholder="기본 인원" name="basic_cnt" value="${room.basic_cnt}">
				            <label for="campAddr">기본 인원</label>
				        </div>
				    </div>
				    <div class="col-md-12">
				        <div class="form-floating mb-1">
				            <input type="number" class="form-control room_price" id="r_price" placeholder="가격" name="r_price" value="${room.r_price}">
     ...
     <div class="col-md-6" id="rcard_btn">
      <div class="card mb-3" style="max-width: 540px; height:280px;">
    		<button type="button" class="btn btn-primary h-100" onclick="cardPlus()">+</button>
   		</div>
	</div>
  </div>
</div>
